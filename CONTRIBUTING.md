# Contributing to UKHSA Quality Assurance Testing

Thank you for your interest in contributing to the UKHSA Quality Assurance Testing!

## Table of Contents

- [Contributing to UKHSA Quality Assurance Testing][1]
  - [Table of Contents][2]
  - [Code of Conduct][3]
  - [Getting Started][4]
...
```bash
git clone https://github.com/ukhsa-collaboration/standards-qat.git
cd standards-qat
```
...
```bash
git clone https://github.com/YOUR-USERNAME/standards-qat.git
cd standards-qat
```

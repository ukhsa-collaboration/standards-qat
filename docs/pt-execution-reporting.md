...
(question) Please visit our internal site for sample report
...
(question) Please visit UKHSA defect management process for detailed process 
...
Log files
To finalize this testing phase, the following criteria must be met:
...
(lightbulb) Important Note Test reports provide statements on whether the system under test adheres to the non-functional requirements (NFRs). The Quality Assurance Team (QAT) does not offer recommendations regarding the promotion of code to production.